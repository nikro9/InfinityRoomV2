...
# Asegurarnos de que pueda encontrar el módulo de config
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '..')))
from src import config

def create_main_chart(df: pd.DataFrame, status_data: dict = None, chart_data: dict = None) -> go.Figure:
    """
    Función centralizada que crea el gráfico principal de Plotly.
    Ahora puede ser usada por cualquier página de la aplicación.
    """
